...
from SequenceBatchNorm import SequenceBatchNorm

from lasagne.layers.recurrent import CustomRecurrentLayer, Gate
...
class LSTMLayer(MergeLayer):
    ...
    precompute_input=True, mask_input=None, only_return_final=False, batch_norm=True,
    **kwargs)
    ...
    batch_norm : bool
        If True, apply batch normalization (sequential-wise normalization) to LSTM.
